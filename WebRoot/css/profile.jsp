...
<html>
  ...
  <link href="${pageContext.request.contextPath}/css/picCut.css" rel="stylesheet" type="text/css">
</head>
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <form action="${pageContext.request.contextPath}/updateuser" method="post" enctype="multipart/form-data">
            ...
            <button id="submitbutton" type="button" class="btn btn-primary submit" >修改信息</button>
       		</form>
