...
<link href="${pageContext.request.contextPath}/css/privatelettertable.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<script src="/bysj/js/privateletter.js"></script>
	<script>
	function getletter() {
    ...
    success: function(data){              
        $(data).each(function(){
        	$("#table").append("<tr><td>"+getUserNick(senderuid)+"</td><td>"+this.message+"</td></tr>");
