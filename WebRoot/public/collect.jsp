...
<input id="typeId" type="hidden" value="${typeId}">
  ...
  <div class="section">
    ...
    <div class="col-md-12">
    <h1 class="" draggable="true">收藏列表</h1>
  ...
  <script src="/bysj/js/searchbox.js"></script>
    ...
    success: function(data){
       ...
       $("#historytable").append("<tr><td>"+i+"</td><td><a href='/bysj/video/"+this.vid+"'>"+getVideoTitle(this.vid)+"</a></td><td>"+dateStr+"</td><td><button type='button' class='btn btn-primary' onclick='deletecollect("+this.cid+")'>删除</button></td></tr>");
					i++; 
